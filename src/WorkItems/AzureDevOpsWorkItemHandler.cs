    ...
    : AzureDevOpsResourceHandlerBase<AzureDevOpsWorkItem, AzureDevOpsWorkItemIdentifiers>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (existing is null)
            await client.CreateAsync(props.Id, props.Title, props.Type, props.Description, cancellationToken);
        else
            await client.UpdateAsync(existing.Value, props.Title, props.Type, props.Description, cancellationToken);
